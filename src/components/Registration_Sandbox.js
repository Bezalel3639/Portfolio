...
class RegistrationSandbox extends Component {
    constructor(props) {
        super();
        this.state = { 
            edit1_value: '',
    ...
    submitData() {
        this.postMongoDBData(endpoints_base + "/v1/BackOffice/Login/RegisterSandboxUser/", {email: this.state.edit1_value,  password: this.state.edit2_value});
    }
...
export default RegistrationSandbox;