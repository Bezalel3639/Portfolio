...
class Login extends Component {
    ...
    componentWillMount(){
        this.setState({ edit1_value: 'user9@yandex.ru', edit2_value: 'test' });
    }
    ...
    onClick() {
        this.getMongoDBData(endpoints_base + "/v1/BackOffice/Login/ValidateUser/" + this.state.edit1_value +"/{password}?password=" + this.state.edit2_value);   
    }
